...
var _b = require('./getSchema'), getRemoteSchema = _b.getRemoteSchema, printToFile = _b.printToFile;
var sync = false;
...
function launchScripts() {
    return __awaiter(this, void 0, void 0, function () {
        var api_key, endpoint, options, valret, schema, valret2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getRemoteSchema(endpoint, options)];
                case 1:
                    valret = _a.sent();
                    if (valret.status == "err") {
                        ...
                        schema = valret.schema;
                        valret2 = printToFile("./schema.graphql", schema);
