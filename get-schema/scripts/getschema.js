...
exports.printToFile = exports.getRemoteSchema = exports.getHeadersFromInput = void 0;
...
function getRemoteSchema(endpoint, options) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, data, errors, message, errorMessage, schema, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), data = _a.data, errors = _a.errors, message = _a.message;
                    errorMessage = errors || message;
                    if (errorMessage) {
                        return [2 /*return*/, { status: 'err', message: JSON.stringify(errorMessage, null, 2) }];
                    }
                    if (options.json) {
                        return [2 /*return*/, {
                                status: 'ok',
                        ...
                        schema = (0, buildClientSchema_1.buildClientSchema)(data);
                        return [2 /*return*/, {
                                status: 'ok',
                                schema: (0, schemaPrinter_1.printSchema)(schema)
                            }];
                    }
                    return [3 /*break*/, 3];
                case 2:
